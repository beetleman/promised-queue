...
Invoke a library API function from the command-line:
    ...
    $ clojure -X beetleman.promised-queue/foo :a 1 :b '"two"'
...
Your library will be deployed to net.clojars.beetleman/promised-queue on clojars.org by default.

## License

Copyright © 2023 Beetleman
